...
public abstract class BaseTest extends api.BastTest {
	...
	public void chooseBrowserAndEnv(String browser, String env, String video, ITestResult result)
			throws MalformedURLException {
		...
		if (env.equalsIgnoreCase("local")) {
			...
			driver = new RemoteWebDriver(new URL("http://52.59.249.26:4444/wd/hub"), cap);
		}
	}
