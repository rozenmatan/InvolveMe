...
public abstract class BasePage {
	...
	/**
	 * @desctiption waits until the top progress bar will reach to a specific
	 *              value(usually check that a page is finish loads)
	 */
	...
	/**
	 * @desctiption waits until an element is fixed and not in motion(usually check
	 *              that a page is finish loads)
	 */
